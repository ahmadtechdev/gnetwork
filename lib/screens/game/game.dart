...
class EarnGameController extends GetxController {
  ...
  void _initializeGame() {
    ...
    // Randomly select 4 images for matching pairs
    final random = Random();
  ...
  void _completeGame() {
    ...
    _gameTimer.cancel();
    score.value += (100 - gameTime.value).clamp(0, 100); // Bonus for speed
  ...
  Widget _buildGameGrid() {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        double cardSize = (availableWidth - 32) / 3; // 3 cards per row with spacing
        cardSize = cardSize.clamp(60.0, 100.0); // Min 60, max 100

        return Center(
          child: Container(
            constraints: BoxConstraints(
              maxWidth: (cardSize * 3) + 32, // 3 cards + spacing
              maxHeight: (cardSize * 3) + 32, // 3 rows + spacing
            ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      _buildCard(6, cardSize),
                      SizedBox(width: 16),
                      _buildCard(7, cardSize),
                    ],
                  ),
